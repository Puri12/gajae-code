...
During invocation, the file or image is already attached to the message. Analyze the attachment directly. Never call other tools, never spawn other agents, and never try to load the file by path.
